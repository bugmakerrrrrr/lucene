...
/**
 * {@link LegacyBytesRefHash} is a special purpose hash-map like data-structure optimized for {@link
 ...
 * to the id is encapsulated inside {@link LegacyBytesRefHash} and is guaranteed to be increased for
 ...
 * @lucene.internal
 */
public final class LegacyBytesRefHash implements Accountable {
  private static final long BASE_RAM_BYTES =
      RamUsageEstimator.shallowSizeOfInstance(LegacyBytesRefHash.class)
          +
          // size of Counter
  ...
  /**
   * Creates a new {@link LegacyBytesRefHash} with a {@link ByteBlockPool} using a {@link
   * DirectAllocator}.
   */
  public LegacyBytesRefHash() {
    this(new ByteBlockPool(new DirectAllocator()));
  }

  /** Creates a new {@link LegacyBytesRefHash} */
  public LegacyBytesRefHash(ByteBlockPool pool) {
    this(pool, DEFAULT_CAPACITY, new DirectBytesStartArray(DEFAULT_CAPACITY));
  }

  /** Creates a new {@link LegacyBytesRefHash} */
  public LegacyBytesRefHash(ByteBlockPool pool, int capacity, BytesStartArray bytesStartArray) {
    hashSize = capacity;
  ...
  /**
   * Returns the number of {@link BytesRef} values in this {@link LegacyBytesRefHash}.
   *
   * @return the number of {@link BytesRef} values in this {@link LegacyBytesRefHash}.
   */
  public int size() {
    return count;
  }
   ...
   * this {@link LegacyBytesRefHash} instance.
   *
   * @lucene.internal
   */
  public int[] compact() {
  ...
  /**
   * reinitializes the {@link LegacyBytesRefHash} after a previous {@link #clear()} call. If {@link
  ...
  /**
   * Thrown if a {@link BytesRef} exceeds the {@link LegacyBytesRefHash} limit of {@link
  ...
  public abstract static class BytesStartArray {
     ...
     * The {@link LegacyBytesRefHash} uses this reference to track it memory usage
     *
